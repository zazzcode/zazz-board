...
Notes - in the top of the plan we shoud call out the Procect Code and the Delerable code and the deliverable Id (integer) so the planner agent does not need to look up these values