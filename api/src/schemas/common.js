...
export const deliverableResponseSchema = {
  ...
  properties: {
    ...
    plannedStartAt: { type: 'string', format: 'date-time', nullable: true, description: 'Planned deliverable start timestamp used by the project Gantt view.' },
    plannedCompletionAt: { type: 'string', format: 'date-time', nullable: true, description: 'Planned deliverable completion timestamp used by the project Gantt view.' },
    actualStartAt: { type: 'string', format: 'date-time', nullable: true, description: 'Actual start timestamp recorded from execution status.' },
    actualCompletionAt: { type: 'string', format: 'date-time', nullable: true, description: 'Actual completion timestamp recorded from execution status.' },
